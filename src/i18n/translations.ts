...
export const translations = {
  en: {
    ...
    metricFuelPrice: 'Gasoline Price',
    fuelPriceUnit: 'USD/L',
    fuelPriceNote: 'RON 95 National Avg · Incl. Tax',
    fuelLowPrice: 'Subsidized / Low',
    fuelMidPrice: 'Global Avg',
    fuelHighPrice: 'High Fuel Tax',
    mapResetZoom: 'Reset',
    mapZoomIn: 'Zoom In',
    mapZoomOut: 'Zoom Out',
    ...
    colFxRate: 'FX Rate ({base})',
    colStockIndex: 'Stock Benchmark',
    colFuelPrice: 'Gasoline ($/L)',
    ...
    tableMobileHint: 'Swipe horizontally to explore all 12 economic indicators',
    tableMobileAllMetrics: '12 Indicators',
  ...
  ko: {
    ...
    metricFuelPrice: '휘발유 가격',
    fuelPriceUnit: 'USD/L',
    fuelPriceNote: 'RON 95 전국평균 · 세금 포함',
    fuelLowPrice: '저유가·산유국',
    fuelMidPrice: '글로벌 평균',
    fuelHighPrice: '고유류세',
    mapResetZoom: '초기화',
    mapZoomIn: '확대',
    ...
    colDebt: '부채비율',
    colInflation: '인플레이션',
    tableMobileHint: '좌우로 스크롤하여 12개 전체 경제 지표 탐색',
    tableMobileAllMetrics: '12개 지표',
  ...
  ja: {
    ...
    metricFuelPrice: 'ガソリン価格',
    fuelPriceUnit: 'USD/L',
    fuelPriceNote: 'RON 95 全国平均・税込',
    fuelLowPrice: '安値・産油国',
    fuelMidPrice: '世界平均',
    fuelHighPrice: '高燃料税',
    mapResetZoom: 'リセット',
    ...
    colDebt: '債務比率',
    colInflation: 'インフレ率',
    tableMobileHint: '左右にスクロールして全12指標を確認',
    tableMobileAllMetrics: '12指標',
  ...
  es: {
    ...
    metricFuelPrice: 'Precio de Gasolina',
    fuelPriceUnit: 'USD/L',
    fuelPriceNote: 'RON 95 Promedio Nacional · Con impuestos',
    fuelLowPrice: 'Bajo (Subsidiado)',
    fuelMidPrice: 'Promedio Global',
    fuelHighPrice: 'Altos Impuestos',
    ...
    tableMobileHint: 'Desliza horizontalmente para ver los 12 indicadores',
    tableMobileAllMetrics: '12 Indicadores',
  ...
  zh: {
    ...
    metricDebt: '政府负债率',
    metricInflation: '通胀率',
    metricFuelPrice: '汽油价格',
    fuelPriceUnit: 'USD/L',
    fuelPriceNote: 'RON 95 全国平均 · 含税',
    fuelLowPrice: '低价·产油国',
    fuelMidPrice: '全球平均',
    fuelHighPrice: '高燃油税',
    mapResetZoom: '重置',
    ...
    colDebt: '负债率',
    colInflation: '通胀率',
    tableMobileHint: '左右滑动即可查看全部 12 项经济指标',
    tableMobileAllMetrics: '12项指标',
